...
Generate the hessian function of the objective vector of `sys`, for the `hess` field of
`SciMLBase.MultiObjectiveOptimizationFunction`. Since the objective is vector-valued,
the generated function returns a vector of hessian matrices.
